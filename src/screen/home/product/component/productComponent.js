    ...
    render() {
        return (
            <View style={{margin:10}}>
                ...
                shadowOpacity:5,
                shadowRadius:5,paddingTop:20,marginBottom:30,backgroundColor:'white'
                    ,flex:1,
                }}>
                  <View style={{paddingTop:15,paddingBottom:45,paddingLeft:15,paddingRight:15}} >
                    ...
                    <View style={{flexDirection:'row',paddingRight:10}}>
                      ...
                      <Text style={{color:'gray',fontSize:16,fontFamily:'NunitoRegular',paddingRight:10}}>
                      {"Lauren Ipsum is a whimsical "}</Text>
                    </View>
                  </View>
                </View>
